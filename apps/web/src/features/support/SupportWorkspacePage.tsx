...
function SupportTicketCustomerSnapshot({
  ...
  return (
    <div className="space-y-2.5">
      ...
      <div className="rounded-[16px] border border-[color:var(--color-border)] bg-[color:var(--color-surface)] px-3.5 py-2.5">
  ...
  return (
    <div className="space-y-5">
      ...
      {variant === 'queue' ? (
        ...
        <div className="space-y-2.5">
          <section className="overflow-hidden rounded-[24px] border border-[rgba(22,42,93,0.1)] bg-white shadow-[0_14px_28px_rgba(19,33,79,0.07)]">
            <div className="px-4 py-2.5 sm:px-5">
              <div className="space-y-1">
                ...
                <h3 className="max-w-5xl text-[1.28rem] font-semibold tracking-[-0.05em] leading-tight text-[color:var(--color-ink)]">
                  {ticketDetail.title}
                </h3>

                <div className="grid gap-1.5 border-t border-[color:var(--color-border)] pt-1.5 text-[13px] md:grid-cols-2 xl:grid-cols-4">
                  <div className="min-w-0">
                    <p className="text-[10px] font-semibold uppercase tracking-[0.14em] text-[color:var(--color-muted)]">
                      Cliente
                    </p>
                    <p className="mt-0.5 truncate font-semibold text-[color:var(--color-ink)]">
          ...
          <div
            className={cx(
              ...
              ticketRailOpen && 'xl:grid-cols-[minmax(0,1fr)_284px]',
            )}
          >
            <section
              className="overflow-hidden rounded-[24px] border border-[color:var(--color-border)] bg-white shadow-[0_14px_28px_rgba(19,33,79,0.07)]"
            ...
            >
              ...
              <div className="border-t border-[color:var(--color-border)] bg-[linear-gradient(180deg,rgba(247,250,255,0.96),rgba(255,255,255,1))] px-4 py-2.5 sm:px-5">
                <form className="space-y-1.5" onSubmit={handleSubmitComposer}>
                  ...
                  <div className="rounded-[18px] border border-[color:var(--color-border)] bg-white px-3.5 py-2.5 shadow-[0_8px_18px_rgba(19,33,79,0.04)]">
                    <TextareaInput
                      className="min-h-[68px] resize-y border-0 bg-transparent px-0 py-0 text-[14px] leading-[1.45rem] shadow-none focus:border-transparent focus:ring-0"
                      onChange={(event) =>
                        composerMode === 'public'
                      ...
                      value={composerDraft}
                    />
                    <div className="mt-2.5 flex flex-wrap items-center justify-between gap-2.5 border-t border-[color:var(--color-border)] pt-2.5">
                      ...
                      <div className="flex flex-wrap items-center gap-3">
                        <SelectInput
                          className="min-w-[124px] rounded-full px-3.5 text-[13px] font-semibold"
                          onChange={(event) =>
