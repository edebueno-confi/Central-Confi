...
## Objetivo do produto
Criar uma plataforma interna robusta para:
- organizar chamados;
...
- preparar IA operacional segura.
...
- Engenharia/produto.
- Gestores internos.
- Clientes B2B do Genius Returns e futuros produtos SaaS do grupo.

## Fora de escopo
- Atendimento de shopper final.
